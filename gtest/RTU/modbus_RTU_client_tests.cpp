...
class RtuClientTestFixture : public ::testing::Test
{
  public:
    ...
    RtuClientTestFixture() : m_client(m_portMock)
    {
...
TEST_F(RtuClientTestFixture, ReadHoldingRegisters_Request1)
{
    ...
    const uint8_t expectedFrame[] = {0x01, 0x03, 0x00, 0x10, 0x00, 0x02, 0xC5, 0xCE};
...
TEST_F(RtuClientTestFixture, ReadHoldingRegisters_Request2)
{
    ...
    const uint8_t expectedFrame[] = {0x02, 0x03, 0x00, 0x20, 0x00, 0x04, 0x45, 0xF0};
...
TEST_F(RtuClientTestFixture, ReadCoils_Request)
{
    ...
    const uint8_t expectedFrame[] = {0x02, 0x01, 0x00, 0x20, 0x00, 0x04, 0x3C, 0x30};
...
TEST_F(RtuClientTestFixture, ReadDiscreteInputs_Request)
{
    ...
    const uint8_t expectedFrame[] = {0x02, 0x02, 0x00, 0x20, 0x00, 0x04, 0x78, 0x30};
...
TEST_F(RtuClientTestFixture, ReadInputRegisters_Request)
{
    ...
    const uint8_t expectedFrame[] = {0x02, 0x04, 0x00, 0x20, 0x00, 0x04, 0xF0, 0x30};
...
TEST_F(RtuClientTestFixture, WriteSingleCoil_Request)
{
    ...
    const uint8_t expectedFrame[] = {0x02, 0x05, 0x00, 0x20, 0xFF, 0x00, 0x8D, 0xC3};
...
TEST_F(RtuClientTestFixture, WriteSingleRegister_Request)
{
    ...
    const uint8_t expectedFrame[] = {0x02, 0x06, 0x00, 0x20, 0x12, 0x34, 0x85, 0x44};
...
TEST_F(RtuClientTestFixture, WriteMultipleRegisters_Request)
{
    ...
    const uint8_t expectedFrame[] = {0x02, 0x10, 0x00, 0x20, 0x00, 0x02, 0x04, 0x12, 0x34, 0x56, 0x78, 0x85, 0xC7};
